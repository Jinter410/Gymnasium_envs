...
if __name__ == '__main__':
    checkpoint_path = './models/256_128_neur+forward+backwards+sharp+BERTSmall+NormalizedMinMSELoss/model_epoch_200.pth'  # Remplacer par le chemin de votre checkpoint
